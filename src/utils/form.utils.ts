...
export function registerInput(
  ...
  return {
    ...register(name, {
      ...
      minLength: minLenght ? { message: `Min length is ${minLenght}`, value: minLenght } : undefined,
      maxLength: maxLength ? { message: `Min length is ${maxLength}`, value: maxLength } : undefined,
      pattern: email
        ? {
            value:
